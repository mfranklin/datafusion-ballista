...
pub struct DefaultDistributedPlanner {
    ...
    optimizer_enforce_sorting: EnsureRequirements,
}
...
impl DefaultDistributedPlanner {
    ...
    pub fn new() -> Self {
        Self {
            ...
            optimizer_enforce_sorting: EnsureRequirements::default(),
        }
    }
}
...
",
    ...
    async fn distributed_window_plan() -> Result<(), BallistaError> {
        ...
        */
        ...
        let shuffle_write = stage0
            .as_any()
            .downcast_ref::<SortShuffleWriterExec>()
            .expect("Downcast to SortShuffleWriterExec failed");
